    ...
    >
      ...
      <div>
        ...
        <Button className="group relative inline-flex items-center justify-center overflow-hidden rounded-md bg-gray-800 px-8 py-2.5 tracking-tighter text-white">
          <span className="absolute h-0 w-0 rounded-full bg-hy-accent-primary transition-all duration-500 ease-out group-hover:h-56 group-hover:w-56" />
          <span className="absolute bottom-0 left-0 -ml-2 h-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="object-stretch h-full w-auto opacity-100"
          ...
          <span className="absolute inset-0 -mt-1 h-full w-full rounded-lg bg-gradient-to-b from-transparent via-transparent to-teal-200 opacity-30" />
          <Link href={url} className="relative text-base font-semibold">
            {" "}
            Details
          </Link>
